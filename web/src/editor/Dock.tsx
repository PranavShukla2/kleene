          ...
          <motion.aside
            ...
            className={
              spec.edge === 'side'
                ...
                : /*
                    Bottom panels get height as a fraction of the window rather than a fixed
                    number of pixels: a transition table's useful size is "enough rows to see
                    the machine", which scales with the screen, and 40% leaves the diagram the
                    majority it should keep.
                  */
                  'absolute inset-x-0 right-13 bottom-0 z-30 flex max-h-[40vh] min-h-64 flex-col border-t border-k-border bg-k-surface/95 shadow-xl backdrop-blur'
            }
          >
